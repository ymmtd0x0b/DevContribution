  ...
  class AssignedIssue
    def call(user)
      ...
      issues_id_referenced_by_other_users =
        ...
        filter_pull_requests_assigned_by_other_users_from(issues_id, user.id) +
        filter_pull_requests_reviewed_by_other_users_from(issues_id, user.id) +
    ...
    def filter_pull_requests_assigned_by_other_users_from(issues_id, user_id)
    ...
    def filter_pull_requests_reviewed_by_other_users_from(issues_id, user_id)
